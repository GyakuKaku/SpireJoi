...
public class DiscoveryLiveCardAction extends AbstractGameAction {
    private boolean retrieveCard = false;
    private boolean returnColorless = false;

    public DiscoveryLiveCardAction() {
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        this.amount = 1;
    }

    public DiscoveryLiveCardAction(int amount) {
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        this.amount = amount;
    }

    public DiscoveryLiveCardAction(boolean colorless, int amount) {
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        this.amount = amount;
    ...
    private ArrayList<AbstractCard> generateCardChoices() {
        ...
        while(derp.size() != 3) {
            ...
            for (AbstractCard c : AbstractDungeon.srcCommonCardPool.group) {
                if (c.hasTag(CardTagEnum.LIVE) && !c.hasTag(AbstractCard.CardTags.HEALING)) {
                    list.add(c);
